...
%Em um instante $t$, é analisada uma rede {\it mesh} com diversas transmissões ocorrendo simultaneamente. Em $t$, pode-se ver quais enlaces estão estabelecidos e em qual direção a transmissão está ocorrendo. Os nós e os enlaces em $t$ podem ser interpretados como um grafo direcionado $G=(V, E)$. Nesse grafo, $V$ é o conjunto de nós (vértices) e $E$ é o conjunto de enlaces que possuem uma direção de transmissão específica (arestas direcionadas). 
...
%Um conjunto de enlaces $C$ que desejamos analisar é um subconjunto de todos os enlaces da rede., ou seja $C \subset E$.
