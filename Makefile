...
scheduling: scheduling.o Algorithm1.o Algorithm2.o Network.o Link.o Node.o
	$(CC) scheduling.o Algorithm1.o Algorithm2.o Network.o Link.o Node.o -o scheduling
